...
namespace Calculator
{
    public partial class Form1 : Form, ICalc
    {
        ...
        {
            MessageBox.Show("Version 2.0", "Calculation", MessageBoxButtons.OKCancel);
        }
        ...
        private void MS_MouseEnter(Object sender, EventArgs e)
        {
            (sender as Button).BackColor = System.Drawing.Color.Yellow;
        }

        private void MS_MouseLeave(Object sender, EventArgs e)
        {
            (sender as Button).BackColor = System.Drawing.Color.MintCream;
        }

        private void Mplus_MouseEnter(Object sender, EventArgs e)
        {
            (sender as Button).BackColor = System.Drawing.Color.Yellow;
        }

        private void Mplus_MouseLeave(Object sender, EventArgs e)
        {
            (sender as Button).BackColor = System.Drawing.Color.MintCream;
        }

        private void Mminus_MouseEnter(Object sender, EventArgs e)
        {
            (sender as Button).BackColor = System.Drawing.Color.Yellow;
        }

        private void Mminus_MouseLeave(Object sender, EventArgs e)
        {
            (sender as Button).BackColor = System.Drawing.Color.MintCream;
        }
